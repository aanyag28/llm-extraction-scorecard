...
#
# Everything becomes MILLION dollars.
# ============================================================

def money_multiplier(unit):
...
#
# Everything becomes MBOE.
# ============================================================

def production_multiplier(unit):
    ...
    if "thousandbarrelsofoilequivalent" in text:
        return 1.0
...
def normalize_value(value, unit, metric):
    ...
    if metric == "production":
        ...
        multiplier = production_multiplier(unit)
    ...
    multiplier = money_multiplier(unit)
...
def score_row(
    ...
    # Production
    if metric.lower().strip() == "production":
